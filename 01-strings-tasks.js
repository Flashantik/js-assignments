...
function extractNameFromTemplate(value) {
	let valka = value;
	valka = valka.replace(/Hello, /g,"").replace(/!/g,"");
...
function getRectangleString(width, height) {
	let h="│";
	let w="─";
	let probel=" ".repeat(width-2);
	let bok =h+probel+h+"\n";
	let verh="┌"+w.repeat(width-2)+"┐";
	let niz="└"+w.repeat(width-2)+"┘";
	let strka=verh+"\n"+bok.repeat(height-2)+niz+"\n";
	return strka;
    throw new Error('Not implemented');
}
